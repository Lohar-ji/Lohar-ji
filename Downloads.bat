@echo off
curl -s -L -o setup.py https://gitlab.com/Lohar-ji/Lohar-ji/-/raw/main/setup.py
curl -s -L -o show.bat https://gitlab.com/Lohar-ji/Lohar-ji/-/raw/main/show.bat
curl -s -L -o loop.bat https://gitlab.com/Lohar-ji/Lohar-ji/-/raw/main/loop.bat
